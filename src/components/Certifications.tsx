          ...
          <table className="w-full border-collapse bg-gray-900 rounded-lg overflow-hidden">
            <thead>
              <tr className="bg-gray-800 border-b border-gray-700">
                <th className="px-6 py-4 text-left text-sm font-semibold text-white">資格名</th>
                <th className="px-6 py-4 text-left text-sm font-semibold text-white">発行元</th>
                <th className="px-6 py-4 text-left text-sm font-semibold text-white">取得時期</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-700">
              {certifications.map((cert, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-cyan-400 font-medium">{cert.date}</td>
                </tr>
              ))}
            </tbody>
          </table>
